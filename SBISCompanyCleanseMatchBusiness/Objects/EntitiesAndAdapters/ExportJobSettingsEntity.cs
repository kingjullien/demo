...
{
    public class ExportJobSettingsEntity
    {
        ...
        public bool MatchOutPut { get; set; }
        ...
        public bool CompanyTree { get; set; }
    ...
    public class ReExportDataEntity
    {
        public string SrcRecordId { get; set; }
    ...
    public class MonitoringNotificationJobSettingsEntity
    {
        public int Id { get; set; }
        public int UserId { get; set; }
