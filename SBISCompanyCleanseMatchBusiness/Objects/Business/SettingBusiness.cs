...
{
    public class SettingBusiness : BusinessParent
    {
        SettingRepository rep;
        public SettingBusiness(string connectionString) : base(connectionString) { rep = new SettingRepository(Connection); }
        ...
        public void UpdateSettings(List<SettingEntity> Setttings)
        {
            rep.UpdateSettings(Setttings);
        }
        #endregion

        #region Group Country
        public List<CountryGroupEntity> GetCountryGroups()
        {
            List<CountryGroupEntity> results = new List<CountryGroupEntity>();
            results = rep.GetCountryGropus();
            return results;
        }
        ...
        public List<UsersEntity> GetUsersStatus()
        {
            List<UsersEntity> results = new List<UsersEntity>();
            results = rep.GetUsersList();
            return results;
        ...
        {
            UsersEntity result = new UsersEntity();
            result = rep.GetUserDetailsByUserName(userName);
            return result;
        }
        ...
        public List<DnbAPIEntity> GetDnBAPIList(string APIType, int credId)
        {
        ...
        public List<AutoAdditionalAcceptanceCriteriaEntity> GetAutoAcceptanceDetailsPagedSorted(int SortOrder, int PageNumber, int PageSize, out int TotalRecords, int ConfidenceCode, int CountyGroup, string Tags, string LOBTag, bool Active)
        {
            ...
            results = rep.GetAutoAdditionalAcceptanceCriteriaPagedSorted(SortOrder, PageNumber, PageSize, out TotalRecords, ConfidenceCode, CountyGroup, Tags, LOBTag, Active);
            return results;
        }
        ...
        public DataTable GetTopMatchGradeSetting(bool IsTopMatch)
        {
            return rep.GetTopMatchGradeSettings(IsTopMatch);
        }
        ...
        public void RunAutoAcceptanceRule(int UserId)
        {
        ...
        {
            List<AutoAdditionalAcceptanceCriteriaEntity> results = new List<AutoAdditionalAcceptanceCriteriaEntity>();
            results = rep.GetAutoAdditionalAcceptanceCriteria();
            return results;
        }
        ...
        {
            rep.DeleteUserMachineDetails(UserId, BrowserAgent);
        }
        ...
        {
            DataTable results = new DataTable();
            results = rep.GetAutoAdditionalAcceptanceCriteriaExportToExcel(LicenseEnableTags, ConfidenceCode, MatchGrade, CountyGroupId, Tags);
            return results;
        }
        #endregion
