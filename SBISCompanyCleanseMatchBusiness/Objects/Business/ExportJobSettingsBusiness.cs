...
{
    public class ExportJobSettingsBusiness : BusinessParent
    {
        ExportJobSettingsRepository rep;
        public ExportJobSettingsBusiness(string connectionString) : base(connectionString) { rep = new ExportJobSettingsRepository(Connection); }
        ...
        public void UpdateExportJobSettings(ExportJobSettingsEntity obj, bool IsPorcessStart, bool IsRevert, int RetryCount, string ErrorMessage = null)
        {
            rep.UpdateExportJobSettings(obj, IsPorcessStart, IsRevert, RetryCount, ErrorMessage);
        }
        public void UpdateMonitoringExportJobSettings(MonitoringNotificationJobSettingsEntity obj, bool IsPorcessStart, bool IsRevert, int RetryCount, string ErrorMessage = null)
        {
