...
{
    public class CompanyFacade : FacadeParent
    {
        CompanyBusiness rep;
        public CompanyFacade(string connectionString, string UserName) : base(connectionString, UserName) { rep = new CompanyBusiness(Connection); }
        ...
        public void AcceptLCMMatches(List<MatchEntity> Matches)
        {
        ...
        public void AcceptLCMMatches(List<MatchEntity> Matches, int UserId, bool IsApprove = true)
        {
            rep.AcceptLCMMatches(Matches, UserName, UserId, IsApprove);
        }

        public void RejectLCMMatches(List<CompanyEntity> Companies)
        {
        ...
        /// </summary>
        /// <param name="Matches"></param>
        public void RejectLCMMatches(List<CompanyEntity> Companies, int UserId, bool IsApprove = true)
        {
            rep.RejectLCMMatches(Companies, UserName, UserId, IsApprove);
        }
        public void AcceptBIDMatch(CompanyEntity company, MatchEntity matchEntity)
        {
            rep.AcceptBIDMatch(company, matchEntity, UserName);
        }
        public void UpdateBIDRecord(List<CompanyEntity> Companies)
        {
            rep.UpdateBIDRecord(Companies, UserName);
        }

        public void DeleteBIDData(List<CompanyEntity> Companies)
        {
        ...
        public DataSet GetReport(string strReportType)
        {
            return rep.GetReport(strReportType);
        }
        public DataSet GetActiveDataStatistics(string LOBTag)
        {
        ...
        public void AuthenticateApplication(string ClientGUID, string connection)
        {
            try
            {
                General.setAuthConnectionString(connection);
        ...
        #region "Review - Build 119"
        public DataTable GetReviedData(int ConfidenceCode, string MatchGrade, string MDP, bool IsTopMatch, int CountryGroupId, string OrderByColumn, int PageSize, int PageIndex, out int TotalRecord)
        {
        ...
        public SqlDataReader ExportBadInputDataQueueDataReader(string Tag, string ImportProcess, string LOBTag, bool FlagExport, string SrcRecID, bool SrcRecIdExactMatch)
        {
