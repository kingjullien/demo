...
{
    //class OIExportJobSettingsFacade
    public class OIExportJobSettingsFacade : FacadeParent
    {
        OIExportJobSettingsBusiness rep;
        ...
        #endregion
        public OIExportJobSettingsFacade(string connectionString) : base(connectionString) { rep = new OIExportJobSettingsBusiness(Connection); }
